...
var width = 46;
var border = 2;
var firebase = new Firebase("https://intense-heat-325.firebaseio.com/");
var checkersGame = firebase.child("game-1");
var fbMoveCount = firebase.child("game-1-movecount");
...
$('document').ready(function() {
    ...
    fbMoveCount.on("value", function(snapshot){
      $("#moveCount").html(snapshot.val());
    }, function(err){
